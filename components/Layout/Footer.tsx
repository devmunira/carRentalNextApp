...
const Footer = () => {
  return (
    <footer className='flex flex-col flex-wrap px-10 sm:px-16 py-5 border-t border-gray-100 mt-5'>
        <div className='flex max-md:flex-col flex-wrap justify-between gap-5 py-5'>


            <div className='flex flex-col gap-6 justify-start items-start'>
              <Image src={'/logo.png'} alt={'Logo'} width={138} height={18}></Image>
